...
function Opener({onClick}: {onClick?: () => void}) {
  ...
  <div className="absolute left-[435px] top-[170px] border-4 border-white flex justify-center items-center px-6 bg-indigo-800 rounded-full h-[60px] w-[60px] max-md:px-5">
    <img
      loading="lazy"
